...
export const ApprovalProtocolSchemas = {
  ...
  ExecApprovalGrantsListParams: execApprovals.ExecApprovalGrantsListParamsSchema,
  ExecApprovalStandingGrant: execApprovals.ExecApprovalStandingGrantSchema,
  ExecApprovalGrantsListResult: execApprovals.ExecApprovalGrantsListResultSchema,
  ExecApprovalGrantsRevokeParams: execApprovals.ExecApprovalGrantsRevokeParamsSchema,
  ExecApprovalGrantsRevokeResult: execApprovals.ExecApprovalGrantsRevokeResultSchema,
